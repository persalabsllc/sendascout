...
import { IconBuildingStore, IconCalendarRepeat, IconDashboard, IconSettings, IconTargetArrow, IconUser, IconWallet } from "@tabler/icons-react";
import { Brand } from "./brand";
import { MobileDashboardNav } from "./mobile-dashboard-nav";

export function CustomerDashboardShell({ active, name, children }: { active: "overview" | "payments" | "profile" | "saved" | "business"; name: string; children: React.ReactNode }) {
