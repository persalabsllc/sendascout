  ...
  if (complete) return (
    <main className="onboarding-page">
      ...
      <section className="success-card">
        ...
        <p>{customer ? "Stripe confirmed your payment. Matching Scouts in the selected service area can review and claim the mission as soon as publication finishes." : "Your Scout application and profile photo are saved. Finish the secure Stripe step so your identity and payout account can be verified, then you’ll be ready to claim matching missions."}</p>
        ...
        <Link className="button" href={customer ? "/dashboard/customer" : "/dashboard/scout/earnings"}>{customer ? "Open dashboard" : "Finish Stripe payout setup"} <IconArrowRight size={19} /></Link>
      </section>
    </main>
  );
