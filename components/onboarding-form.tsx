  ...
  if (complete) return (
    <main className="onboarding-page">
      ...
      <section className="success-card">
        ...
        <p>{customer ? "Matching Scouts in the selected service area can review and claim it now. You’ll receive an alert when a Scout accepts." : "Your founding Scout profile is saved. We’ll notify you when nearby mission opportunities match your service area."}</p>
