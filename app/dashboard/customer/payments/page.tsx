...
export default async function CustomerPaymentsPage() {
  ...
  const committed = rows.filter((mission) => !["draft", "cancelled"].includes(mission.status));
